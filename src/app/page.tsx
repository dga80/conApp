    ...
    <div className="min-h-screen bg-[#F8FAFC] flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-5xl w-full mx-auto pb-28 lg:pb-12">
          {isLoading && !summary ? (
            <div className="py-28 flex flex-col items-center justify-center space-y-3 text-slate-400">
              <div className="w-8 h-8 border-3 border-emerald-500 border-t-transparent rounded-full animate-spin" />
              <span className="text-xs font-medium">Cargando presupuesto...</span>
            </div>
          ) : summary ? (
            <>
              {/* ================================================================= */}
                  ...
                  {forecast && (
                    <div className="p-3.5 bg-emerald-50/60 border border-emerald-100 rounded-2xl space-y-1">
                      <span className="text-[10px] text-emerald-800 uppercase tracking-wider font-bold block">
                        Transferir antes del día 1 ({forecast.targetMonthName})
                      </span>
                      <div className="text-2xl font-black text-emerald-950">
                        {formatCurrency(forecast.sharePerPerson)} / persona
                      </div>
                    </div>
                  )}
